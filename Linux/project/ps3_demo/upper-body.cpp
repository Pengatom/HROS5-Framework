...
int main(int argc, char *argv[])
{
	...
	while (arbotixpro.ReadByte(JointData::ID_MIN, MXDXL::P_VERSION, &firm_ver, 0)  != ArbotixPro::SUCCESS)
		{
...
//	printf("m value %d \n", m);
	...
	else if ((argc > 1 && strcmp(argv[1], "-off") == 0) || (StatusCheck::m_cur_mode == 0)){
			printf("No position detected.\n");
			if(true){
				printf("Sit down.\n");
...
//	int ll[6] = { JointData::ID_L_ANKLE_ROLL, JointData::ID_L_ANKLE_PITCH, JointData::ID_L_KNEE, JointData::ID_L_HIP_PITCH, JointData::ID_L_HIP_ROLL, JointData::ID_L_HIP_YAW };
	int rl[6] = { JointData::ID_R_SHOULDER_ROLL, JointData::ID_R_SHOULDER_PITCH, JointData::ID_R_ELBOW, JointData::ID_R_SHOULDER_ROLL, JointData::ID_R_SHOULDER_PITCH, JointData::ID_R_ELBOW };
	int ll[6] = { JointData::ID_L_SHOULDER_ROLL, JointData::ID_L_SHOULDER_PITCH, JointData::ID_L_ELBOW, JointData::ID_L_SHOULDER_ROLL, JointData::ID_L_SHOULDER_PITCH, JointData::ID_L_ELBOW };
	...
	if (dMaxAngle3 < 20 && dMaxAngle3 < dMaxAngle1 && dMaxAngle3 < dMaxAngle2)
		m = Robot::WALK_READY;
//	printf("\ndAngle1 = %d, dAngle2 = %d, dAngle3 = %d\n", dAngle1, dAngle2, dAngle3);
	printf("\nSitting = %d, Standing = %d, Walk Ready = %d\n", dMaxAngle1, dMaxAngle2, dMaxAngle3);
